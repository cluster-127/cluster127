      ...
      <div className="flex flex-col gap-8 md:flex-row items-center justify-between">
        <Link href="/" className="flex items-center gap-4 z-20 p-4">
          <svg
            ...
            <path
              fill="#fff"
              d="M350 440c49.706 0 90-40.294 90-90s-40.294-90-90-90-90 40.294-90 90 40.294 90 90 90"
            />
            <path fill="#fff" d="M655 655H45V207.635l60 60V595h490V105H267.635l-60-60H655z" />
          </svg>
